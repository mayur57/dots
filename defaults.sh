...
# Quit settings to avoid overriding our setup
...
# Disable sound beep feedback
defaults write NSGlobalDomain com.apple.sound.beep.feedback -int 0

# Disable sound beep flash
...
# Always save screenshots in PNG format (other options: BMP, GIF, JPG, PDF, TIFF)
defaults write com.apple.screencapture type -string "png"

# Disable shadow in screenshots as it is annoying to share
